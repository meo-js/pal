...
import type { AnyBufferSource } from '@meojs/std/typed-array';
 ...
 * 文件数据支持类型
 */
export type FileData = string | AnyBufferSource;
...
export async function write(
  ...
  opts?: (ModifyFileOptions & { encoding?: Encoding.Binary }) | Encoding.Binary,
): Promise<void>;
export async function write(
  path: PathLike,
